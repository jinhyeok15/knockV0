<script>
	...
	import Mydoc from './mydoc/Mydoc.svelte';
...
<style>
	...
	.mydoc {left: -1px;}.search {left: 97.5px;}.package {left: 195px;}
	...
	.loginbar_component a {
		color: black;
	}
	.login {width: 80px; height: 30px;} .join {left: 100px; width: 80px; height: 30px;}
